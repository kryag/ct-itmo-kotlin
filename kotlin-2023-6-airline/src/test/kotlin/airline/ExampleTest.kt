...
class ExampleTest {
    ...
    fun testBooking() {
        ...
        testAndCancel {
            ...
            checkEmails("test@example.com", flightId1, "2B", "already taken")
            Assertions.assertEquals(setOf("1A", "1B", "2A"), booking.freeSeats(flightId1, flightTime))
            ...
            checkEmails("kbats@itmo.ru", flightId1, "does not exist")
            Assertions.assertEquals(setOf("1A", "1B", "2A"), booking.freeSeats(flightId1, flightTime))
            ...
            sleep()
            checkEmails("test@hello.com", "does not exist")
            ...
            sleep()
            checkEmails("ipetrov@mail.ru", "already closed")
    ...
    private suspend fun sleep(interval: Duration = 300.milliseconds) {
        delay(interval)
    }
